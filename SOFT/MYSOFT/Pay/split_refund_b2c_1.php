	...
	if($frm_ver != 4)
	 ...
	 /*商户生成的订单号(最多10位)*/	
	  ...
	  $strSaler   = $frm_spid;				
		...
		$strRetUrl  = "http://www.my-soft.net.cn/Pay/split_refund_respond.php";
		//取签名机构key	
		...
		/*生成MD5签名*/
			$strSignText = 
						...
						genNameVal("refund_id",$strRefundID).
...
<script>
	function SubMit()
	{
		...
		document.getElementById('frm').action="https://www.tenpay.com/cgi-bin/v4.0/refund.cgi";
		alert(document.getElementById('frm').action);
		document.getElementById('frm').submit();
		return false;
	}	
</script>
<form id="frm" target="_blank" action="https://mch.tenpay.com/cgi-bin/refund_b2c.cgi">
	...
	<fieldset ><legend>分账退款信息</legend>
		<label>退款单</label><input readonly name="refund_id" value="<? echo $strRefundID; ?>"><br>
	...
	<fieldset ><legend>签名信息</legend>
		...
		<label></label><input type="submit" value="确认上述信息(商户系统)"><input type="button" value="确认上述信息(主站)" onclick="javascript:return SubMit();"><br>
