...
// *************************************************
#ifndef xiaoqiang_md5_xor_D99_T99_CDATABASEHASH_H_HEADER_INCLUDED_B3CA14F7
#define xiaoqiang_md5_xor_D99_T99_CDATABASEHASH_H_HEADER_INCLUDED_B3CA14F7
...
class xiaoqiang_md5_xor_D99_T99_CDatabaseHash:public CDatabaseHash
{
  public:
    // 初始化，使用一个字符串数组
    ...
    xiaoqiang_md5_xor_D99_T99_CDatabaseHash();

    //##ModelId=4C35985801E1
    virtual ~xiaoqiang_md5_xor_D99_T99_CDatabaseHash();
/*
...
#endif /*xiaoqiang_md5_xor_D99_T99_ CDATABASEHASH_H_HEADER_INCLUDED_B3CA14F7 */
